    ...
    <div class="container">
        <div class="row mb-20">
            ...
            <div class="col-xs-12 col-sm-10 col-md-8 text-center">
                <h2 class="text-uppercase">Nos <span class="color_red">partenaires</span></h2>
                <div class="line_1-1"></div>
                <div class="line_2-2"></div>
                <div class="line_3-3"></div>
                <p class="heading_space">Ils nous ont fait confiance !</p>
            </div>
            <div class="col-sm-1 col-md-2"></div>
        </div>
        <div class="col-md-12">
            <div class="row">
                <div id="our-partner-slider" class="owl-carousel">
                    ...
                    <div class="item"><img src="{{ asset('assets/images/client/partner-5.jpg') }}" alt="Partners"></div>
                    <div class="item"><img src="{{ asset('assets/images/client/8.jpg') }}" alt="Partners"></div>
